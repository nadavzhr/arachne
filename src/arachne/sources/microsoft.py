"""Microsoft source implementation with per-source normalization.

Microsoft (and Nvidia) provide `positionUrl` suffixes; build full URLs from
`cfg.apply_base` or derive base from `cfg.url`.
"""
