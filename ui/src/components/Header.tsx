...
export const Header = ({ theme, setTheme, exportToJson }: HeaderProps) => {
  return (
    <header className="border-b border-arachne-border bg-arachne-surface px-4 md:px-8 h-16 flex items-center justify-between shrink-0 relative z-10 w-full">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[10px] text-arachne-muted font-mono tracking-tighter">DATA CATCH v0.1</span>
        </div>
      </div>
